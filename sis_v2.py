...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT INFORMATION SYSTEM", font=("Times New Roman", 30))
        label.place(x=230,y=20)

        home = tk.Button(self, text="HOME",font=("Times New Roman",16,"bold"),bd=0, width = 10, bg="Green", fg="white", command=lambda: controller.show(Home))
        home.place(x=380,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Times New Roman",16,"bold"),bd=0, width = 10, bg="Green", fg="white", command=lambda: controller.show(Courses))
        course.place(x=568,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Times New Roman",16,"bold"),bd=0, width = 13, bg="Green", fg="white", command=lambda: controller.show(Students))
        students.place(x=750,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Times New Roman",15,"bold"),bd=0, width = 10, bg="Green", fg="white", command=iExit)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Times New Roman", 40))
        ...
        home = tk.Button(self, text="HOME",font=("Lucida Console",13,"bold"),bd=0, width = 10, bg="Green", fg="white", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.SearchBar = Entry(self, font=("Lucida Console", 11), textvariable=SearchBar_Var, bd=0,bg="Gray",width=31)
        ...
        self.adds = Button(self, text="ADD", font=('Lucida Console', 11, ), height=1, width=10, bd=1, bg="Green", fg="white",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Lucida Console', 11), height=1, width=10, bd=1, bg="Green", fg="white", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Lucida Console', 11), height=1, width=10, bd=1, bg="Green", fg="white", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Lucida Console', 11), height=1, width=10, bd=1, bg="Green", fg="white", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Lucida Console', 11, 'bold'),bd=0, bg= "Green", fg="white", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Lucida Console', 11, 'bold'), height=1, width=11, bg="Green", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Lucida Console", 40))
        label.place(x=130,y=20)
        
        home = tk.Button(self, text="HOME",font=("Lucida Console",12,"bold"),bd=0, width = 7, bg="Green", fg="white",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.txtyear = ttk.Combobox(self, value=["BS STAT", "BS MATH", "BS IT", "BSCS","BSA","BS Bio","BS Chem","BSCE","BSHM","BS Micr","BSN","BA Hist","BAPhil","BA PoSc"], state="readonly", font=("Lucida Console", 12), textvariable=Course_Code, width=28)
        ...
        self.add = Button(self, text="REGISTER", font=('Times New Roman', 11), height=1, width=10, bd=1,  bg="Green", fg="white", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Times New Roman', 11), height=1, width=10, bd=1, bg="Green", fg="white", command=update_stud)
        self.update.place(x=250,y=420)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Times New Roman', 11), height=1, width=10, bd=1, bg="Green", fg="white", command=clear)
        self.clear.place(x=350,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Times New Roman', 11), height=1, width=10, bd=1, bg="Green", fg="white", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Times New Roman', 11, 'bold'),bd=0, bg= 'Green', fg="white", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Times New Roman', 11, 'bold'), height=1, width=11,  bg="Green", fg="white",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
